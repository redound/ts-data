...
var DataService = (function () {
    ...
    DataService.prototype.all = function (resourceName) {
        return this.execute(this.query(resourceName)).then(function (response) {
    ...
    DataService.prototype.updateModel = function (resourceName, model, data, onlyChanges, includeRelations) {
        if (onlyChanges === void 0) { onlyChanges = true; }
        if (includeRelations === void 0) { includeRelations = true; }
        var recursive = includeRelations;
        if (onlyChanges && model instanceof ActiveModel_1.default) {
    ...
    DataService._updateModel = function (model, data) {
        console.log('ASSIGNING', data, model);
