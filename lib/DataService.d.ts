...
export default class DataService implements QueryExecutorInterface {
    ...
    all(resourceName: string): ng.IPromise<DataServiceResponseInterface<ModelList<any>>>;
    find(resourceName: string, resourceId: any): ng.IPromise<DataServiceResponseInterface<any>>;
