...
(function (RequestHandlerFeatures) {
    ...
    RequestHandlerFeatures[RequestHandlerFeatures["EXCLUDES"] = 6] = "EXCLUDES";
...
var RequestHandler = (function () {
    ...
    RequestHandler.prototype.createRequestOptions = function (query) {
    ...
    RequestHandler.prototype.applyPlugins = function (requestOptions, query) {
        var allowedFeatures = [];
    ...
    RequestHandler.prototype.getUsedFeatures = function (query) {
        var features = [];
        if (query.hasOffset()) {
